...
const tableSx: SxProps<Theme> = {
  ...
  '& td.ts': { color: 'text.secondary', whiteSpace: 'nowrap', fontSize: '12.5px' },
  '& td.body': { fontFamily: 'monospace', fontSize: '12px', color: 'text.primary', maxWidth: 380 },
  '& td.scope': { fontFamily: 'monospace', fontSize: '12px', color: 'text.secondary', whiteSpace: 'nowrap' },
...
const LogTable = ({ rows, total, page, pageSize, loading, onPageChange, onPageSizeChange }: Props) => {
