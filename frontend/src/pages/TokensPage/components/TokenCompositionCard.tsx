...
const TokenCompositionCard = ({
  ...
  return (
    <Paper variant="outlined" sx={{ p: '22px 24px' }}>
      <Box sx={{ fontFamily: "'Sora', sans-serif", fontWeight: 600, fontSize: 16 }}>Token composition</Box>
      ...
      >
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', minWidth: 0 }}>
          <Box sx={{ position: 'relative', width: SIZE, height: SIZE, mx: 'auto', my: 1 }}>
            ...
            >
              <Typography sx={{ fontFamily: "'Sora', sans-serif", fontWeight: 800, fontSize: 36, lineHeight: 1, letterSpacing: -1 }}>
                {centerValue}
              </Typography>
