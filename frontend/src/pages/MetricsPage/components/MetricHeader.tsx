  ...
  return (
    <Paper variant="outlined" sx={{ p: '22px 24px' }}>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.375, flexWrap: 'wrap' }}>
        <Typography sx={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 19, fontWeight: 700, letterSpacing: '-0.3px' }}>
          {metric.name}
        </Typography>
        <Box
          sx={(t) => ({
            ...
            bgcolor: `color-mix(in srgb, ${t.palette.info?.main ?? '#1aa7dd'} 18%, transparent)`,
          })}
        >
