...
@Schema(name = "ToolFailure", description = "Failed-tool-call breakdown by tool, error_type, and an example scope/message")
public record ToolFailure(
        ...
        @Schema(description = "Number of failed calls with this (tool, errorType) pair", example = "3") long count) {
}
